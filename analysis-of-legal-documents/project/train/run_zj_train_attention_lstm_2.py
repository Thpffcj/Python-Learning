...
from attention_lstm_2 import TRNNConfig, TextRNN
...
save_path = os.path.join(save_dir, 'best_validation_attention_lstm_2')  # 最佳验证结果保存路径
    ...
    for epoch in range(config.num_epochs):
        ...
        for x1_batch, x2_batch, y_batch in batch_train:
            ...
            if total_batch % config.print_per_batch == 0:
                ...
                filename = '../result/printLog_attention_lstm_2.txt'
